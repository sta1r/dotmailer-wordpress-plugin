...
registerBlockType( 'cgb/block-dd-block', {
	...
	var id = props.attributes.id || '';
		...
		dotsurvey.surveys = [{"label": "-- Select survey --", "value":-1}, {"label":"SnowYo survey","value":"https://r1.dotmailer-surveys.com/204mlv7a-a03jwe7f"},{"label":"Cats or dogs?","value":"https://r1.dotmailer-surveys.com/204mlv7a-e12tvh14"}]
		var retval = [];
